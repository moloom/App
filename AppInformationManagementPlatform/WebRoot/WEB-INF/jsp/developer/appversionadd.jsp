...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>
					新增APP版本信息 <small>当前用户：${devUserSession.devName}</small>
				</h2>
				<div class="clearfix"></div>
			</div>
			<div class="x_title">
			...
			<div class="x_content1">
								...
								<tbody>
									<c:forEach var="appVersion" items="${appVersionList }"
										...
										<tr role="row" class="odd">
											...
											<td><a href="${appVersion.APKLocPath }">${appVersion.APKFileName }</a>
											</td>
				...
				<div class="x_content" style="display: block;">
					...
					<form class="form-horizontal form-label-left"
						action="saveAppVersion.html" method="post"
						enctype="multipart/form-data">
						<input type="hidden" id="appId" name="appId"
							value="${app_info.id}">
						<!-- 自己加一个隐藏框，值为当前登录的开发者id -->
						<input type="hidden" id="createdBy" name="createdBy"
							value="${devUserSession.id}">
