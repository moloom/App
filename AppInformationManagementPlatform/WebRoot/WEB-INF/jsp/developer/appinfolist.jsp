							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select name="status" class="form-control">
									<c:if test="${statusList != null }">
									   ...
									   <c:forEach var="appStatus" items="${statusList}">
									   		<option <c:if test="${appStatus.statusCode == queryStatus }">selected="selected"</c:if>
									   		value="${appStatus.statusCode}">${appStatus.statusName}</option>
									   </c:forEach>
									</c:if>
        						</select>
							</div>
								...
								<select name="flatfromId" class="form-control">
									<c:if test="${flatFormList != null }">
									   ...
									   <c:forEach var="flatForms" items="${flatFormList}">
									   		<option <c:if test="${flatForms.id == queryFlatformId }">selected="selected"</c:if>
									   		value="${flatForms.id}">${flatForms.flatFormName}</option>
									   </c:forEach>
									</c:if>
        						</select>
							</div>
