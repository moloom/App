...
<title>APP开发者平台</title>
	...
	<link href="${pageContext.request.contextPath }/statics/css/bootstraps/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
	<!-- JQVMap -->
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-edit"></i> APP应用管理<span
									...
									<ul class="nav child_menu">
										<li><a href="${pageContext.request.contextPath }/dev/findAppList.html">APP维护</a>
										</li>
